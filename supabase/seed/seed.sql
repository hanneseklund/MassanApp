...
Experience is our main asset. For 30 years we have learned and understood Aspen wood’s best characteristics and, therefore, have been able to bring out its best value, creating functional and aesthetic solutions for interior and sauna design.'), 'https://www.4plus.lv', 'assets/images/exhibitors/nordbygg-2026-4plus.jpg'),
  ...
  ('nordbygg-2026-exhibitor-138597', 'nordbygg-2026', 'Aalberts hfc B.V.', 'A04:22', jsonb_build_object('en', 'Kom och upptäck vår innovativa teknologi i monter A11:38.
...
Vi maximerar systemets prestanda och minskar energiförbrukningen genom effektiv hydronisk design, över hela världen.', 'sv', 'Kom och upptäck vår innovativa teknologi i monter A11:38.
...
Vi maximerar systemets prestanda och minskar energiförbrukningen genom effektiv hydronisk design, över hela världen.'), 'https://flamcogroup.com/se', 'assets/images/exhibitors/nordbygg-2026-aalberts-hfc-b-v.jpg'),
  ('nordbygg-2026-exhibitor-134668', 'nordbygg-2026', 'Aalberts Integrated Piping Systems B.V.', 'A04:22', jsonb_build_object('en', 'Aalberts integrated piping systems utvecklar och tillverkar kopplingar, rör och ventiler i i olika metaller för distribution och kontroll av vätskor och gaser. Vår teknik gör det möjligt för våra kunder att arbeta snabbt och tillförlitligt på ett enkelt och effektivt vis. De skräddarsydda systemen är lämpliga för användning inom bland annat bostads-, industri- och kommersiella byggnader.', 'sv', 'Aalberts integrated piping systems utvecklar och tillverkar kopplingar, rör och ventiler i i olika metaller för distribution och kontroll av vätskor och gaser. Vår teknik gör det möjligt för våra kunder att arbeta snabbt och tillförlitligt på ett enkelt och effektivt vis. De skräddarsydda systemen är lämpliga för användning inom bland annat bostads-, industri- och kommersiella byggnader.'), 'https://www.aalberts-ips.se', 'assets/images/exhibitors/nordbygg-2026-aalberts-integrated-piping-systems-b-v.jpg'),
  ('nordbygg-2026-exhibitor-138461', 'nordbygg-2026', 'AB Dalatimmer', 'C14:72', jsonb_build_object('en', 'Timmerhus med unik design, hög kvalitet och hållbarhet i fokus

Vi är experter på timmerhus och levererar allt från stommar till nyckelfärdiga hus. Vi arbetar över hela Sverige med omnejd.', 'sv', 'Timmerhus med unik design, hög kvalitet och hållbarhet i fokus
...
Vi är experter på timmerhus och levererar allt från stommar till nyckelfärdiga hus. Vi arbetar över hela Sverige med omnejd.'), 'https://www.dalatimmer.se', 'assets/images/exhibitors/nordbygg-2026-ab-dalatimmer.jpg'),
  ('nordbygg-2026-exhibitor-135228', 'nordbygg-2026', 'AB Fromax', 'A07:35', jsonb_build_object('en', 'Vi erbjuder en rad olika verktyg för kapning och bockning av de vanligaste typerna av rör exempelvis stål, gjutjärn och koppar med eller utan isolering och i en mängd olika dimensioner. Verktygen distribueras av de ledande återförsäljarna i branschen. Vi vet att professionella användare ställer höga krav på sin utrustning och våra verktyg är konstruerade för att tillmötesgå VVS-installatörers behov, både med avseende på kvalitet och precision. För oss är det viktigt att ha ett brett sortiment inom våra produktområden och vår målsättning är att oavsett vilken typ av rör som krävs för ett visst jobb, så skall våra kunder alltid kunna hitta rätt FROMAX verktyg..', 'sv', 'Vi erbjuder en rad olika verktyg för kapning och bockning av de vanligaste typerna av rör exempelvis stål, gjutjärn och koppar med eller utan isolering och i en mängd olika dimensioner. Verktygen distribueras av de ledande återförsäljarna i branschen. Vi vet att professionella användare ställer höga krav på sin utrustning och våra verktyg är konstruerade för att tillmötesgå VVS-installatörers behov, både med avseende på kvalitet och precision. För oss är det viktigt att ha ett brett sortiment inom våra produktområden och vår målsättning är att oavsett vilken typ av rör som krävs för ett visst jobb, så skall våra kunder alltid kunna hitta rätt FROMAX verktyg..'), 'https://www.fromax.com', 'assets/images/exhibitors/nordbygg-2026-ab-fromax.jpg'),
  ('nordbygg-2026-exhibitor-139309', 'nordbygg-2026', 'AB Svensk Värme', 'A07:19', jsonb_build_object('en', 'Svensk Värme är ett teknik- och kompetensföretag med ett brett sortiment av produkter och tjänster inom energilösningar för både fastighet och industri.

Vi levererar högkvalitativa produkter och servicetjänster för optimering & energibesparing inom processindustrier samt värme- och kylsystem.', 'sv', 'Svensk Värme är ett teknik- och kompetensföretag med ett brett sortiment av produkter och tjänster inom energilösningar för både fastighet och industri.
...
Vi levererar högkvalitativa produkter och servicetjänster för optimering & energibesparing inom processindustrier samt värme- och kylsystem.'), 'https://www.svenskvarme.com', 'assets/images/exhibitors/nordbygg-2026-ab-svensk-varme.jpg'),
  ...
  ('nordbygg-2026-exhibitor-133959', 'nordbygg-2026', 'Abelko Innovation', 'A13:12', jsonb_build_object('en', 'Abelko är en långsiktig partner inom automation, mätteknik och energieffektivisering. Vi utvecklar egna produkter samt utvecklar system på uppdrag av våra kunder - det har vi gjort i över 50 år!
...
Vi vågar påstå att vi är unika med vårt engagemang och vilja när det gäller att erbjuda våra kunder den bästa servicen och supporten på marknaden. Vi vill alltid överträffa kundens förväntningar genom kort responstid och leverera en kundupplevelse i världsklass.'), 'https://www.abelko.se', 'assets/images/exhibitors/nordbygg-2026-abelko-innovation.jpg'),
 ...
 ABUS har all sin tillverkning i Tyskland, hos ABUS Kransysteme GmbH. Förutom Sverige så har ABUS aktiv försäljning i drygt 55 länder runtom i världen, sporadisk försäljning i ytterligare dryga 30 länder. I Karlstad återfinns huvudkontor med utbildningsenhet och centralt reservdelslager med ca 600 artiklar där vi bland annat har 50-talet kättingtelfrar mellan 100kg och 2ton samt HB-skenor för snabb leverans av kompletta system alt. ombyggnationer.'), 'https://www.abus-kransystem.se', 'assets/images/exhibitors/nordbygg-2026-abus-kransystem-jj-gruppen-carlhag.jpg'),
  ('nordbygg-2026-exhibitor-139101', 'nordbygg-2026', 'AccuraSee', 'AG:54', jsonb_build_object('en', 'AccuraSee är en BI&analys-plattform som hämtar data från flera olika källor för att hantera fakturering, rapportering och ekonomisk analys - helt automatiskt, dygnet runt - för att visa vad du tjänar pengar på.', 'sv', 'AccuraSee är en BI&analys-plattform som hämtar data från flera olika källor för att hantera fakturering, rapportering och ekonomisk analys - helt automatiskt, dygnet runt - för att visa vad du tjänar pengar på.'), 'https://www.accurasee.se', 'assets/images/exhibitors/nordbygg-2026-accurasee.jpg'),
  ('nordbygg-2026-exhibitor-134364', 'nordbygg-2026', 'ACEVE', 'C02:01', jsonb_build_object('en', 'Next One Technology AB heter numera Aceve Sverige AB.
...
Det betyder att vi har fått fler kollegor med mycket kunskap och erfarenhet – och tillsammans kan vi fortsätta utveckla ännu bättre lösningar för branschen.'), 'https://next-tech.com/', 'assets/images/exhibitors/nordbygg-2026-aceve.jpg'),
  ('nordbygg-2026-exhibitor-139401', 'nordbygg-2026', 'ACEVE.', 'C01:01', jsonb_build_object('en', 'Aceve samlar Sveriges ledande affärssystem för bygg- och installationsbranschen – Next, Hantverksdata, Rekyl, Accurator, Dox och KlarPris.
Tillsammans har vi över 50 års erfarenhet och brinner för att utveckla lösningar som stärker lönsamheten och förenklar vardagen för våra kunder.', 'sv', 'Aceve samlar Sveriges ledande affärssystem för bygg- och installationsbranschen – Next, Hantverksdata, Rekyl, Accurator, Dox och KlarPris.
Tillsammans har vi över 50 års erfarenhet och brinner för att utveckla lösningar som stärker lönsamheten och förenklar vardagen för våra kunder.'), 'https://next-tech.com/', 'assets/images/exhibitors/nordbygg-2026-aceve-2.jpg'),
  ('nordbygg-2026-exhibitor-137251', 'nordbygg-2026', 'Ackurat Industriplast AB', 'C08:20', jsonb_build_object('en', 'Vi utvecklar och tillverkar komponenter för en rad olika industrier. Med ett brett och väl genomarbetat standardsortiment kan vi snabbt möta våra kunders behov.
...
När behovet går bortom standard tar vi det hela vägen. Vi utvecklar och producerar verktyg för helt kundunika lösningar, från idé och konstruktion till färdig detalj. På så sätt säkerställer vi optimal funktion, kvalitet och effektiv produktion – anpassad efter varje kunds specifika krav.', 'sv', 'Vi utvecklar och tillverkar komponenter för en rad olika industrier. Med ett brett och väl genomarbetat standardsortiment kan vi snabbt möta våra kunders behov.
...
När behovet går bortom standard tar vi det hela vägen. Vi utvecklar och producerar verktyg för helt kundunika lösningar, från idé och konstruktion till färdig detalj. På så sätt säkerställer vi optimal funktion, kvalitet och effektiv produktion – anpassad efter varje kunds specifika krav.'), 'https://www.ackurat.se', 'assets/images/exhibitors/nordbygg-2026-ackurat-industriplast-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-134550', 'nordbygg-2026', 'ACSS Sanitet och Inredning AB', 'A09:04', jsonb_build_object('en', 'ACSS Sanitet - För publik miljö!
Vi säljer sanitetsarmaturer och system med fokus på kvalitet och funktion för publika miljöer som sport-, simhallar och gym. Vårt moderna och smarta elektroniska system passar också väldigt bra för psykiatri- och kriminalvården. Gemensamt för våra produkter är att det är självstängande och mycket tåliga.', 'sv', 'ACSS Sanitet - För publik miljö!
Vi säljer sanitetsarmaturer och system med fokus på kvalitet och funktion för publika miljöer som sport-, simhallar och gym. Vårt moderna och smarta elektroniska system passar också väldigt bra för psykiatri- och kriminalvården. Gemensamt för våra produkter är att det är självstängande och mycket tåliga.'), 'https://www.acss-sanitet.se', 'assets/images/exhibitors/nordbygg-2026-acss-sanitet-och-inredning-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-139281', 'nordbygg-2026', 'ADT', 'A22:28', jsonb_build_object('en', 'Flexoduct marknadsför flexibla ventilationskanaler samt fläktar för hem, industri och bostäder.
...
Dynair tillverkar industri fläktar, rökgasfläktar samt ATEX fläktar', 'sv', 'Flexoduct marknadsför flexibla ventilationskanaler samt fläktar för hem, industri och bostäder.
...
Dynair tillverkar industri fläktar, rökgasfläktar samt ATEX fläktar'), 'https://www.flexoduct.se', 'assets/images/exhibitors/nordbygg-2026-adt.jpg'),
  ('nordbygg-2026-exhibitor-140015', 'nordbygg-2026', 'AEGIR TECHNOLOGY', 'A13:36', jsonb_build_object('en', 'Visste du att biofilm är den största orsaken till ineffektivitet, korrosion och driftproblem i vattenburna system?
...
Aegir Impulse = smartare vattenbehandling för framtidens fastigheter.', 'sv', 'Visste du att biofilm är den största orsaken till ineffektivitet, korrosion och driftproblem i vattenburna system?
...
Med ett brett sortiment av produkter och tjänster, vår specialistkunskap och med logistik i världsklass gör vi det enklare att vara proffs.'), 'https://www.ahlsell.se', 'assets/images/exhibitors/nordbygg-2026-ahlsell-sverige-ab.jpg'),
  ('nordbygg-2026-exhibitor-134817', 'nordbygg-2026', 'Aircoil AB', 'A18:18', jsonb_build_object('en', 'Vi på Aircoil har Nordens bredaste utbud av batterier, kylmedelkylare, fläktkonvektorer och andra värmeväxlande produkter för att matcha dina behov. Som din egen expert på kyla, värme och ventilation är vi med dig hela vägen, in warm and cool.', 'sv', 'Vi på Aircoil har Nordens bredaste utbud av batterier, kylmedelkylare, fläktkonvektorer och andra värmeväxlande produkter för att matcha dina behov. Som din egen expert på kyla, värme och ventilation är vi med dig hela vägen, in warm and cool.'), 'https://www.aircoil.se', 'assets/images/exhibitors/nordbygg-2026-aircoil-ab.jpg'),
  ('nordbygg-2026-exhibitor-134819', 'nordbygg-2026', 'Airfi Oy', 'A14:19', jsonb_build_object('en', 'Airfi är ett finskt teknologiföretag som specialiserar sig på design och tillverkning av moderna, energieffektiva och intelligenta ventilationsaggregat samt innovativa kökskåpor som aktivt styr inomhusventilationen.
...
Företaget har tilldelats Nyckelflaggan, som framhäver finsk design och tillverkning.', 'sv', 'Airfi är ett finskt teknologiföretag som specialiserar sig på design och tillverkning av moderna, energieffektiva och intelligenta ventilationsaggregat samt innovativa kökskåpor som aktivt styr inomhusventilationen.
...
Airios, IVY', 'sv', 'We are THE OEM controller specialists and develop and produce (custom-made) electronics and software for ventilation and heating systems.
Key words: Modularity, RF, wired bus, BLE, WiFi, Installer app, basic and extended boards, configurable.
Brands we will feature
Airios, IVY'), 'https://www.airios.eu', 'assets/images/exhibitors/nordbygg-2026-airios.jpg'),
  ('nordbygg-2026-exhibitor-137338', 'nordbygg-2026', 'AJ Produkter AB', 'C02:30', jsonb_build_object('en', 'En helhetsleverantör för bättre arbetsplatser
...
Dessutom jobbar vi gärna nära kunderna för att i samverkan skapa bästa möjliga inredningslösning. Bland annat genom vår projektförsäljning där vi leder inredningsprojekt och stöttar kunderna hela vägen – från vision till verklighet. Våra projektsäljare besöker gärna er på plats och hjälper till med mätning, utformning och smarta, ergonomiska och platsbesparande lösningar för er verksamhet. Vi tillhandahåller en mängd olika skydd och tillbehör för att skräddarsy och optimera ert lager efter era behov.', 'sv', 'En helhetsleverantör för bättre arbetsplatser
...
Dessutom jobbar vi gärna nära kunderna för att i samverkan skapa bästa möjliga inredningslösning. Bland annat genom vår projektförsäljning där vi leder inredningsprojekt och stöttar kunderna hela vägen – från vision till verklighet. Våra projektsäljare besöker gärna er på plats och hjälper till med mätning, utformning och smarta, ergonomiska och platsbesparande lösningar för er verksamhet. Vi tillhandahåller en mängd olika skydd och tillbehör för att skräddarsy och optimera ert lager efter era behov.'), 'https://www.ajprodukter.se', 'assets/images/exhibitors/nordbygg-2026-aj-produkter-ab.jpg'),
  ('nordbygg-2026-exhibitor-137980', 'nordbygg-2026', 'Ajab Smide AB', 'C15:51', jsonb_build_object('en', 'Välkommen till C15:51 och möt oss från Ajab!
...
Svenskt, innovativt och hållbart – i montern möter du, förutom oss, även några av de andra företagen som ingår i Welandkoncernen. Varmt välkommen!', 'sv', 'Välkommen till C15:51 och möt oss från Ajab!
...
Svenskt, innovativt och hållbart – i montern möter du, förutom oss, även några av de andra företagen som ingår i Welandkoncernen. Varmt välkommen!'), 'https://www.ajabs.se', 'assets/images/exhibitors/nordbygg-2026-ajab-smide-ab.jpg'),
  ('nordbygg-2026-exhibitor-139509', 'nordbygg-2026', 'Aktive Rev.Ops', 'BG:07', jsonb_build_object('en', 'We help Built environment related software and expert companies to grow their business in the Nordics. Software and service buyers we help to identify and test solutions that are suitable for their needs. We bridge the gap between selling and buying.', 'sv', 'We help Built environment related software and expert companies to grow their business in the Nordics. Software and service buyers we help to identify and test solutions that are suitable for their needs. We bridge the gap between selling and buying.'), 'https://www.aktive.fi', 'assets/images/exhibitors/nordbygg-2026-aktive-rev-ops.jpg'),
  ('nordbygg-2026-exhibitor-137905', 'nordbygg-2026', 'Alab Aluman AB', 'C11:33', jsonb_build_object('en', 'Vi kommer presentera och demonstrera våra egentillverkade projektanpassade lösningar i aluminium.
...
Väl mött hörrni!', 'sv', 'Vi kommer presentera och demonstrera våra egentillverkade projektanpassade lösningar i aluminium.
Vårt eget profilsystem med dörrar och fönster till dig som bygger väggar i paneler. Våra foderbildande produkter förkortar avsevärt er monteringstid.
Ytterligare så ställer vi ut våra balkonginglasningar med ramfria vikbara glasluckor med integrerat räcke. Alab är medlem i Balkongföreningen.
Made in Norrland sedan mer än 50 år!
Väl mött hörrni!'), 'https://www.alab.com', 'assets/images/exhibitors/nordbygg-2026-alab-aluman-ab.jpg'),
  ('nordbygg-2026-exhibitor-138441', 'nordbygg-2026', 'AllToa AB', 'EÖ:36', jsonb_build_object('en', 'Toaletter i offentlig utemiljö

Fungerar helt utan vatten, avlopp, el, kompostströ eller kemikalier,

Endast sol och vind krävs', 'sv', 'Toaletter i offentlig utemiljö

Fungerar helt utan vatten, avlopp, el, kompostströ eller kemikalier,

Endast sol och vind krävs'), 'https://www.alltoa.se', 'assets/images/exhibitors/nordbygg-2026-alltoa-ab.jpg'),
  ('nordbygg-2026-exhibitor-136315', 'nordbygg-2026', 'Altech', 'A12:10', jsonb_build_object('en', 'ALTECH – NOGA UTVALDA PRODUKTER FÖR EN HÅLLBAR VVS-INSTALLATION
...
Förutom på webben finns vårt sortiment i ett åttiotal butiker över hela landet samt för omgående leverans från centrallagret direkt till arbetsplatsen.', 'sv', 'ALTECH – NOGA UTVALDA PRODUKTER FÖR EN HÅLLBAR VVS-INSTALLATION
...
Förutom på webben finns vårt sortiment i ett åttiotal butiker över hela landet samt för omgående leverans från centrallagret direkt till arbetsplatsen.'), 'https://altech.se/', 'assets/images/exhibitors/nordbygg-2026-altech.jpg'),
  ('nordbygg-2026-exhibitor-136314', 'nordbygg-2026', 'Alterna Badrum', 'A08:12', jsonb_build_object('en', 'Alterna är ett av Europas ledande varumärken, med ett komplett badrumssortiment.  Utvecklat för att möta kraven i både vardag och projekt.
...
Välkommen till vår monter för att diskutera hur vi tillsammans kan ta nästa steg i projektmarknaden', 'sv', 'Alterna är ett av Europas ledande varumärken, med ett komplett badrumssortiment.  Utvecklat för att möta kraven i både vardag och projekt.
...
With approximately 300 employees worldwide, Aluflam Group combines engineering expertise, international manufacturing, and project-driven innovation to deliver reliable aluminium solutions for construction, maritime, and industrial applications.', 'sv', 'Aluflam Group is an international company specializing in advanced aluminium solutions for demanding architectural and industrial applications. With headquarters in Denmark and activities in more than 10 countries worldwide, the group combines Scandinavian engineering with global manufacturing and project experience.
The company operates across three core business segments:
Construction
The Construction segment focuses on high-performance aluminium systems for the building industry. Aluflam develops and supplies fire-rated and non-fire-rated glazing systems, including facades, doors, windows, and partition solutions. These systems are used in commercial buildings, infrastructure, and architectural projects where safety, aesthetics, and durability are essential.
Marine & Offshore
...
With approximately 300 employees worldwide, Aluflam Group combines engineering expertise, international manufacturing, and project-driven innovation to deliver reliable aluminium solutions for construction, maritime, and industrial applications.'), 'https://aluflam.com', 'assets/images/exhibitors/nordbygg-2026-aluflam-group.jpg'),
  ('nordbygg-2026-exhibitor-139754', 'nordbygg-2026', 'Alumeco Sverige AB', 'C15:23', jsonb_build_object('en', 'Alumeco erbjuder ett spännande spektrum av tak- och fasadmaterial. Välj mellan olika varianter av plåt i aluminium eller koppar samt aluminiumkompositskivor från Stacbond. Stacbond får dig att tänka utanför givna ramar och se nya möjligheter i fasadens utseende och funktion. För Alumeco är inget projekt för stort eller för litet – vi står alltid redo att bistå dig med vår kunskap. Vi ger varje projekt vår odelade uppmärksamhet och vi välkomnar samarbeten med dig som är arkitekt, formgivare, byggherre eller fasadentreprenör.', 'sv', 'Alumeco erbjuder ett spännande spektrum av tak- och fasadmaterial. Välj mellan olika varianter av plåt i aluminium eller koppar samt aluminiumkompositskivor från Stacbond. Stacbond får dig att tänka utanför givna ramar och se nya möjligheter i fasadens utseende och funktion. För Alumeco är inget projekt för stort eller för litet – vi står alltid redo att bistå dig med vår kunskap. Vi ger varje projekt vår odelade uppmärksamhet och vi välkomnar samarbeten med dig som är arkitekt, formgivare, byggherre eller fasadentreprenör.'), 'https://www.alumeco.se', 'assets/images/exhibitors/nordbygg-2026-alumeco-sverige-ab.jpg'),
...
Vår vision är att bli "Nordens bästa kompletta leverantör av aluminium".', 'sv', 'Alutrade är en komplett leverantör av aluminiumprofiler till svensk industri. Vi finns i Växjö och är idag 40 medarbetare. Oavsett om det gäller specialprofiler eller standardprofiler så har vi den erfarenhet och det kunnande som ger våra kunder en optimal lösning. Vi har över 40 års erfarenhet av allt som rör aluminiumprofiler.
...
Vår vision är att bli "Nordens bästa kompletta leverantör av aluminium".'), 'https://www.alutrade.se', 'assets/images/exhibitors/nordbygg-2026-alutrade-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-137088', 'nordbygg-2026', 'Ambiductor AB', 'A11:28', jsonb_build_object('en', 'En leverantör av energimätare, vattenmätare samt sensorer inom Internet-of-Things. Gör mätinsamling enkel genom mjukvaruplattformen AmbiSolution.', 'sv', 'En leverantör av energimätare, vattenmätare samt sensorer inom Internet-of-Things. Gör mätinsamling enkel genom mjukvaruplattformen AmbiSolution.'), 'https://www.ambiductor.se', 'assets/images/exhibitors/nordbygg-2026-ambiductor-ab.jpg'),
  ('nordbygg-2026-exhibitor-134546', 'nordbygg-2026', 'Amiga AB', 'B11:20', jsonb_build_object('en', 'AMIGA – Passion. Innovation. Hållbarhet. POWER YOU.
...
Vi ger dig kraften att förändra.', 'sv', 'AMIGA – Passion. Innovation. Hållbarhet. POWER YOU.
...
Handcrafted quality • European supply • Best price-performance'), 'https://poats.eu', 'assets/images/exhibitors/nordbygg-2026-arlans-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-136976', 'nordbygg-2026', 'Armatec AB', 'A05:18', jsonb_build_object('en', 'Din partner i framtidens tekniska utmaningar.

Du har en teknisk utmaning. Vi har mängder av kunskap och produkter. Våra koncept visar hur och var vi kan tillföra nytta. Varje teknisk lösning är anpassad efter dina behov.', 'sv', 'Din partner i framtidens tekniska utmaningar.
...
Du har en teknisk utmaning. Vi har mängder av kunskap och produkter. Våra koncept visar hur och var vi kan tillföra nytta. Varje teknisk lösning är anpassad efter dina behov.'), 'https://www.armatec.com/sv', 'assets/images/exhibitors/nordbygg-2026-armatec-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-138840', 'nordbygg-2026', 'Arqdesign Byggprodukter', 'C10:30', jsonb_build_object('en', 'Arqdesign är specialister på innovativa balkongräcken samt balkonginglasningar för den skandinaviska marknaden.
All vår tillverkning sker i småländska Tranås, i närheten av våra leverantörer,
vilket är en stor fördel både för er och miljön.', 'sv', 'Arqdesign är specialister på innovativa balkongräcken samt balkonginglasningar för den skandinaviska marknaden.
All vår tillverkning sker i småländska Tranås, i närheten av våra leverantörer,
...
Hållbarhet är en viktig del av vår verksamhet, och en betydande del av vår tillverkningsenergi kommer från solenergi.', 'sv', 'Arras OÜ är en privatägd estnisk tillverkare av byggbeslag och infästningslösningar för träkonstruktioner, med över 25 års erfarenhet i branschen. Vi är en pålitlig och långsiktig partner för kunder över hela EU, med särskilt stark närvaro i de nordiska marknaderna.
...
Hållbarhet är en viktig del av vår verksamhet, och en betydande del av vår tillverkningsenergi kommer från solenergi.'), 'https://www.arrascf.eu', 'assets/images/exhibitors/nordbygg-2026-arras-ou.jpg'),
  ('nordbygg-2026-exhibitor-138251', 'nordbygg-2026', 'Arton:1 Projekt AB', 'C11:41E', jsonb_build_object('en', 'Vi tillverkar och levererar helhetslösningar med stål, glas och beslag.
...
Vi är specialister på dörr, glas och beslag i godkänd kombination samtidigt som vi är lösningsorienterade med att hitta vägar för att möta kundens behov - allt inom ramen för regelverken förstås.', 'sv', 'Vi tillverkar och levererar helhetslösningar med stål, glas och beslag.
Arton:1 må vara det yngsta stålpartitillverkande företaget i Sverige, men vi är stolta över vår mångåriga samlade kompetens och erfarenhet av brand- och inbrottsklassade stålparter med rätt skydd och funktion.
...
Vi löser kundernas utmaningar – och levererar mer än bara fästelement.', 'sv', 'Svensk tillverkare av professionella fästelement
...
Vi löser kundernas utmaningar – och levererar mer än bara fästelement.'), 'https://www.astonsweden.com', 'assets/images/exhibitors/nordbygg-2026-aston-sweden-ab.jpg'),
  ('nordbygg-2026-exhibitor-139721', 'nordbygg-2026', 'ATMOCE', 'A22:14', jsonb_build_object('en', 'ATMOCE grundades 2024 och har sitt huvudkontor i Tyskland. Företaget är ett globalt energiteknikbolag med ambitionen att skapa en bättre värld genom förnybar energi.
...
Idag finns ATMOCE:s teknik representerad i över 35 länder, där vi tillsammans med våra partners bygger ett globalt energiekosystem som driver på omställningen mot en hållbar och koldioxidfri framtid.', 'sv', 'ATMOCE grundades 2024 och har sitt huvudkontor i Tyskland. Företaget är ett globalt energiteknikbolag med ambitionen att skapa en bättre värld genom förnybar energi.
...
Idag finns ATMOCE:s teknik representerad i över 35 länder, där vi tillsammans med våra partners bygger ett globalt energiekosystem som driver på omställningen mot en hållbar och koldioxidfri framtid.'), 'https://www.atmoce.com', 'assets/images/exhibitors/nordbygg-2026-atmoce.jpg'),
  ...
  ('nordbygg-2026-exhibitor-137096', 'nordbygg-2026', 'AXS Nordic AB', 'C11:51', jsonb_build_object('en', 'Slimmad glasportal, skjut- & vikväggar, dusch & bastubeslag samt verktyg

Vi på AXS hjälper vi dig med personliga lösningar som passar din verksamhet. Kolla gärna in vårt breda sortiment av kvalitetsvarumärken med marknadens senaste krav – och kontakta oss och berätta om dina behov.', 'sv', 'Slimmad glasportal, skjut- & vikväggar, dusch & bastubeslag samt verktyg
...
Vi på AXS hjälper vi dig med personliga lösningar som passar din verksamhet. Kolla gärna in vårt breda sortiment av kvalitetsvarumärken med marknadens senaste krav – och kontakta oss och berätta om dina behov.'), 'https://www.axsnordic.com', 'assets/images/exhibitors/nordbygg-2026-axs-nordic-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-138256', 'nordbygg-2026', 'bARK Production AB', 'C11:41G', jsonb_build_object('en', 'bARK Timber Facade System är ett innovativt fasadsystem producerat av FSC-certifierat svenskt limträ som tillverkas i Hultsfred.
...
Stick, Grand windows, Partition och Module är hjärtat i bARK Timber Facade System.', 'sv', 'bARK Timber Facade System är ett innovativt fasadsystem producerat av FSC-certifierat svenskt limträ som tillverkas i Hultsfred.
...
Stick, Grand windows, Partition och Module är hjärtat i bARK Timber Facade System.'), 'https://www.barkproduktion.se', 'assets/images/exhibitors/nordbygg-2026-bark-production-ab.jpg'),
  ('nordbygg-2026-exhibitor-139404', 'nordbygg-2026', 'Basta', 'EH:15', jsonb_build_object('en', 'Medvetna produktval - BASTA-systemet hjälper dig att välja hållbara produkter genom vetenskapligt baserade kriterier för att fasa ut farliga ämnen.', 'sv', 'Medvetna produktval - BASTA-systemet hjälper dig att välja hållbara produkter genom vetenskapligt baserade kriterier för att fasa ut farliga ämnen.'), 'https://www.bastaonline.se/', 'assets/images/exhibitors/nordbygg-2026-basta.jpg'),
  ('nordbygg-2026-exhibitor-135780', 'nordbygg-2026', 'BASTEC AB', 'A13:10', jsonb_build_object('en', 'Bastec är ett innovativt företag med drygt 35 års erfarenhet som utvecklare av svenska produkter och tjänster inom fastighetsautomation. Vi har ett nära samarbete med återförsäljare och partners över hela landet, som genomför entreprenader och projekt med Bastec-system till slutkunder. Vi utför även egna styrentreprenader i närområdet, vilket ger oss en unik bredd och värdefulla insikter om de verkliga behoven i dagens fastighetsbransch.
...
Bastec ingår i Swegon Group, ett helägt affärsområde inom börsnoterade Investment AB Latour.', 'sv', 'Bastec är ett innovativt företag med drygt 35 års erfarenhet som utvecklare av svenska produkter och tjänster inom fastighetsautomation. Vi har ett nära samarbete med återförsäljare och partners över hela landet, som genomför entreprenader och projekt med Bastec-system till slutkunder. Vi utför även egna styrentreprenader i närområdet, vilket ger oss en unik bredd och värdefulla insikter om de verkliga behoven i dagens fastighetsbransch.
...
Wolf Bavaria - www.wolf-bavaria.com', 'sv', 'Bavaria officially participates with a joint companies stand and an information center offering a professional brokerage service to help establish contacts with Bavarian companies and comprehensive information on Bavaria as a business and high-tech location.
...
Företaget erbjuder både nya och begagnade maskiner, där begagnade maskiner genomgåtts noggrant och ofta renoverats till nära nyskick, med garanti. Utöver försäljning ingår även service, reparationer och utbildningar för kunder, för att säkerställa trygghet och långsiktighet i kundrelationerna.', 'sv', 'Belano Maskin AB grundades 1957 med målet att erbjuda maskiner av hög kvalitet. Genom åren har företaget byggt upp gedigen erfarenhet och kan idag erbjuda ett mycket brett sortiment inom plåtbearbetningsmaskiner och verktyg.
...
BENGglas and BENGsolar are part of BENGproducts B.V.', 'sv', 'BENGglas offers the world’s best insulating glass (U=0.35) and helps build a more sustainable future—pane by pane.
...
BENGglas and BENGsolar are part of BENGproducts B.V.'), 'https://www.bengglas.nl/en', 'assets/images/exhibitors/nordbygg-2026-bengglas-b-v.jpg'),
  ...
  ('nordbygg-2026-exhibitor-139958', 'nordbygg-2026', 'BESSEY Tool', 'B06:50', jsonb_build_object('en', 'Bessey är en ledande tillverkare av högkvalitativa skruvtvingar för industri och snickerier. Deras sortiment av skruvtvingar inkluderar parallella skruvtvingar, aluminium-, stål- och magnesiumskruvtvingar i flera storlekar. Bessey skruvtvingar är tillverkade av högkvalitativt material för att hålla länge och motstå slitage.

Bessey Tools är en av de mest respekterade tillverkarna av spännverktyg i branschen, och med deras högkvalitativa och pålitliga produkter kan du vara säker på att du får det bästa verktyget för ditt arbete.', 'sv', 'Bessey är en ledande tillverkare av högkvalitativa skruvtvingar för industri och snickerier. Deras sortiment av skruvtvingar inkluderar parallella skruvtvingar, aluminium-, stål- och magnesiumskruvtvingar i flera storlekar. Bessey skruvtvingar är tillverkade av högkvalitativt material för att hålla länge och motstå slitage.
...
Våra logistiklösningar är kundanpassade efter varje kunds unika krav, vare sig det handlar om standardprodukter eller prefabricerade enheter som ska levereras ”just-in-time” till byggarbetsplatsen.', 'sv', 'Beulco Armatur är specialister på VVS-lösningar. Vi har ett genuint intresse och engagemang för våra kunders behov av olika produkter som löser problem och effektiviserar. Det är kombinationen av ett brett basutbud av standardprodukter och prefabricerade VVS-lösningar som är vår största styrka.
...
Resultatet?
Färre screw ups. Bättre flyt. Projekt som faktiskt håller.', 'sv', 'Why screw up when you can BIGUP?
...
Färre screw ups. Bättre flyt. Projekt som faktiskt håller.'), 'https://www.bigup.se', 'assets/images/exhibitors/nordbygg-2026-bigup.jpg'),
  ('nordbygg-2026-exhibitor-139310', 'nordbygg-2026', 'Bil & glasdesign Sverige AB', 'AG:130', jsonb_build_object('en', 'Vi arbetar med allt som går att klistra på hus och bilar.
...
Med över 30 år i branschen fortsätter vi att vidareutbilda oss och skapa bredd för att alltid vara ditt bästa alternativ.', 'sv', 'Vi arbetar med allt som går att klistra på hus och bilar.
...
Med över 30 år i branschen fortsätter vi att vidareutbilda oss och skapa bredd för att alltid vara ditt bästa alternativ.'), 'https://www.bilglasdesign.se', 'assets/images/exhibitors/nordbygg-2026-bil-glasdesign-sverige-ab.jpg'),
  ('nordbygg-2026-exhibitor-134848', 'nordbygg-2026', 'BIM.com', 'C02:11', jsonb_build_object('en', 'Bim.com fungerar som en central knutpunkt för tillförlitlig produktinformation och kopplar samman tillverkare med fastighetsägare, arkitekter och entreprenörer. Vår plattform omfattar bland annat:
...
Tilläggstjänster: Vi erbjuder även tjänster som att skapa BIM-objekt, genomföra Life Cycle Assessments (LCA:er), ta fram Environmental Product Declarations (EPD:er) samt lösningar för datadelning mellan intressenter och över olika system.', 'sv', 'Bim.com fungerar som en central knutpunkt för tillförlitlig produktinformation och kopplar samman tillverkare med fastighetsägare, arkitekter och entreprenörer. Vår plattform omfattar bland annat:
...
Tilläggstjänster: Vi erbjuder även tjänster som att skapa BIM-objekt, genomföra Life Cycle Assessments (LCA:er), ta fram Environmental Product Declarations (EPD:er) samt lösningar för datadelning mellan intressenter och över olika system.'), 'https://www.bim.com', 'assets/images/exhibitors/nordbygg-2026-bim-com.jpg'),
  ...
  ('nordbygg-2026-exhibitor-138839', 'nordbygg-2026', 'Bluebeam', 'C01:03', jsonb_build_object('en', 'Bluebeam är den ledande leverantören av digitala produktivitets- och samarbetslösningar för de branscher som designar och bygger vår värld. Sedan 2002 har företaget utvecklat verktyg för smarta markeringar, realtidssamarbete och molnbaserad dokumenthantering som effektiviserar och förbättrar arbetsflöden.
Lösningarna används av över fyra miljoner yrkesverksamma i mer än 160 länder. Bluebeam har huvudkontor i Pasadena, Kalifornien, och ingår i Nemetschek Group.', 'sv', 'Bluebeam är den ledande leverantören av digitala produktivitets- och samarbetslösningar för de branscher som designar och bygger vår värld. Sedan 2002 har företaget utvecklat verktyg för smarta markeringar, realtidssamarbete och molnbaserad dokumenthantering som effektiviserar och förbättrar arbetsflöden.
Lösningarna används av över fyra miljoner yrkesverksamma i mer än 160 länder. Bluebeam har huvudkontor i Pasadena, Kalifornien, och ingår i Nemetschek Group.'), 'https://www.bluebeam.com', 'assets/images/exhibitors/nordbygg-2026-bluebeam.jpg'),
  ('nordbygg-2026-exhibitor-134964', 'nordbygg-2026', 'Blücher Sweden AB', 'A04:23', jsonb_build_object('en', 'BLÜCHER är ett internationellt ledande företag inom utveckling och tillverkning av rostfria avloppssystem, känt för sin höga kvalitet, innovation och hållbarhet.
...
Med ett starkt kundfokus och ett globalt nätverk av partners och distributörer är BLÜCHER en pålitlig aktör som levererar lösningar anpassade efter varje kunds specifika behov. Vår kombination av teknisk expertis, hög kvalitet och innovativt tänkande gör oss till ett självklart val inom moderna avloppssystem.'), 'https://www.blucher.se', 'assets/images/exhibitors/nordbygg-2026-blucher-sweden-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-139779', 'nordbygg-2026', 'Bohlin & Nilsson AB', 'B04:50', jsonb_build_object('en', 'Elbranschens verktygsleverantör sedan 1948
Bohlin & Nilssons inriktning är försäljning av verktyg, maskiner och förnödenheter till i huvudsak elbranschen, men också till övriga hantverkare, industrier m.fl.', 'sv', 'Elbranschens verktygsleverantör sedan 1948
Bohlin & Nilssons inriktning är försäljning av verktyg, maskiner och förnödenheter till i huvudsak elbranschen, men också till övriga hantverkare, industrier m.fl.'), 'https://www.bohlin-nilsson.se', 'assets/images/exhibitors/nordbygg-2026-bohlin-nilsson-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-136238', 'nordbygg-2026', 'Borghamns Stenförädling AB', 'C04:71', jsonb_build_object('en', 'Svensk kalksten och marmor tillhör den absolut vackraste och samtidigt hårdaste byggnadsstenen i världen. Borghamns Stenförädling AB bryter kalksten vid Vätterns östra strand och Kolmårdsmarmor i de ursprungliga marmorbrotten norr om Bråviken. Råvaran är flera hundra miljoner år gammal och kräver respektfull hantering och likaså förädling i form av kvalificerade stenhuggeriarbeten.', 'sv', 'Svensk kalksten och marmor tillhör den absolut vackraste och samtidigt hårdaste byggnadsstenen i världen. Borghamns Stenförädling AB bryter kalksten vid Vätterns östra strand och Kolmårdsmarmor i de ursprungliga marmorbrotten norr om Bråviken. Råvaran är flera hundra miljoner år gammal och kräver respektfull hantering och likaså förädling i form av kvalificerade stenhuggeriarbeten.'), 'https://www.borghamns-stenforadling.se', 'assets/images/exhibitors/nordbygg-2026-borghamns-stenforadling-ab.jpg'),
  ('nordbygg-2026-exhibitor-137914', 'nordbygg-2026', 'Bosch Power Tools', 'B03:10', jsonb_build_object('en', 'Med fokus på innovation, hållbarhet och användarvänlighet utvecklar Bosch lösningar som ökar produktivitet och precision i det dagliga arbetet – oavsett om det gäller bygg, installation eller renovering. På Nordbygg presenterar Bosch sina senaste professionella nyheter, smarta batterisystem och digitala tjänster som hjälper proffs att arbeta snabbare, säkrare och mer effektivt. Besök montern och upplev verktygsteknik i framkant.', 'sv', 'Med fokus på innovation, hållbarhet och användarvänlighet utvecklar Bosch lösningar som ökar produktivitet och precision i det dagliga arbetet – oavsett om det gäller bygg, installation eller renovering. På Nordbygg presenterar Bosch sina senaste professionella nyheter, smarta batterisystem och digitala tjänster som hjälper proffs att arbeta snabbare, säkrare och mer effektivt. Besök montern och upplev verktygsteknik i framkant.'), 'https://www.bosch-professional.com/se/sv/', 'assets/images/exhibitors/nordbygg-2026-bosch-power-tools.jpg'),
  ('nordbygg-2026-exhibitor-136400', 'nordbygg-2026', 'Bostik AB', 'C02:33', jsonb_build_object('en', 'Bostik och LIP är två starka varumärken inom lim, tätning och byggprodukter – tillsammans i Arkema-koncernen, en global innovatör inom hållbara material.
...
Innovation, hållbarhet och teknisk support är kärnan i vårt gemensamma erbjudande – för bättre bygglösningar, idag och imorgon.', 'sv', 'Bostik och LIP är två starka varumärken inom lim, tätning och byggprodukter – tillsammans i Arkema-koncernen, en global innovatör inom hållbara material.
Bostik erbjuder ett komplett sortiment för professionella och hållbara limnings- och tätningslösningar, med produktion i Helsingborg och stark global närvaro.
LIP är det skandinaviska specialistvarumärket för våtrumssystem och avancerade specialapplikationer, med produktion i Danmark och ledande expertis i Norden.
Tillsammans skapar vi en konkurrenskraftig helhet som förenklar projekt, stärker resultat och ger kunderna trygghet i varje led.
...
- Specialanpassade containerlösningar', 'sv', 'BOXIT erbjuder moderna containrar i flera storlekar och modeller – perfekta för säker förvaring av verktyg, material och maskiner direkt på byggarbetsplatsen. Med egna lastbilar och fasta leveranspriser levererar vi containrar över hela Sverige. Hyr enkelt så länge ni behöver.
...
Brainial används av företag inom bygg, infrastruktur, transport, IT och professionella tjänster i hela Europa för att förbättra effektiviteten, minska regelefterlevnadsrisker och öka vinstfrekvensen i komplexa offentliga och privata upphandlingar. Plattformen är molnbaserad inom EU och utvecklad för att uppfylla höga krav på säkerhet och dataskydd för företag.'), 'https://brainial.com', 'assets/images/exhibitors/nordbygg-2026-brainial.jpg'),
  ...
  ('nordbygg-2026-exhibitor-139524', 'nordbygg-2026', 'Brickley Rental AB', 'BG:26 (+1)', jsonb_build_object('en', 'Genom att kombinera säkerhet med digital intelligens erbjuder vi lösningar som håller det värdefulla inne och tjuvarna ute. Våra smarta system ser till att allt funkar som det ska, utan att du behöver hålla koll på minsta detalj. Enkelt, smidigt och problemfritt.', 'sv', 'Genom att kombinera säkerhet med digital intelligens erbjuder vi lösningar som håller det värdefulla inne och tjuvarna ute. Våra smarta system ser till att allt funkar som det ska, utan att du behöver hålla koll på minsta detalj. Enkelt, smidigt och problemfritt.'), 'https://brickley.se/', 'assets/images/exhibitors/nordbygg-2026-brickley-rental-ab.jpg'),
  ('nordbygg-2026-exhibitor-138081', 'nordbygg-2026', 'Brukspecialisten Sverige AB', 'EH:13 (+1)', jsonb_build_object('en', 'Vi har ställt om och vill leda den cirkulära omställningen inom murat och putsat byggande.
...
Välkommen till ett nytt cirkulärt murat och putsat byggande!', 'sv', 'Vi har ställt om och vill leda den cirkulära omställningen inom murat och putsat byggande.
...
Resource allocation and demand planning for contractors to schedule their workers and forecast future needs.', 'sv', 'Resource sharing system to rent workers between contractors - internal, partnerships, external.
Resource allocation and demand planning for contractors to schedule their workers and forecast future needs.'), 'https://www.builder.as', 'assets/images/exhibitors/nordbygg-2026-builder-as.jpg'),
  ('nordbygg-2026-exhibitor-135776', 'nordbygg-2026', 'Burlington / Brittania Bad AB', 'A07:15', jsonb_build_object('en', 'Brittania Bad är en komplett kollektion av olika engelska varumärken med klassisk viktoriansk stil. England har varit det ledande landet inom badrumsdesign sedan förra sekelskiftet och badrumskollektionen är därför sammansatt för att tillgodose den svenska marknaden. Våra produkter möjliggör skapandet av ett gammaldags badrum i elegant engelsk stil.', 'sv', 'Brittania Bad är en komplett kollektion av olika engelska varumärken med klassisk viktoriansk stil. England har varit det ledande landet inom badrumsdesign sedan förra sekelskiftet och badrumskollektionen är därför sammansatt för att tillgodose den svenska marknaden. Våra produkter möjliggör skapandet av ett gammaldags badrum i elegant engelsk stil.'), 'https://www.brittaniabad.se', 'assets/images/exhibitors/nordbygg-2026-burlington-brittania-bad-ab.jpg'),
  ('nordbygg-2026-exhibitor-138683', 'nordbygg-2026', 'BWT Vattenteknik AB', 'A05:11', jsonb_build_object('en', 'BWT är Europas ledande företag inom vattenbehandling. Med över 90 års erfarenhet erbjuder vi skräddarsydda lösningar för att rena, filtrera och mjukgöra vatten - från kommunal vattenförsörjning och industriprocesser till rent dricksvatten i hemmet.

Vår teknik - som omvänd osmos, UV-rening, filtermedia och jonbytessystem - används i fastigheter, industrier, sjukhus, hotell, restauranger och privata bostäder. Genom att minska kalk, energiförbrukning och slitage hjälper vi våra kunder att skydda sina installationer och spara resurser.', 'sv', 'BWT är Europas ledande företag inom vattenbehandling. Med över 90 års erfarenhet erbjuder vi skräddarsydda lösningar för att rena, filtrera och mjukgöra vatten - från kommunal vattenförsörjning och industriprocesser till rent dricksvatten i hemmet.
...
Vår teknik - som omvänd osmos, UV-rening, filtermedia och jonbytessystem - används i fastigheter, industrier, sjukhus, hotell, restauranger och privata bostäder. Genom att minska kalk, energiförbrukning och slitage hjälper vi våra kunder att skydda sina installationer och spara resurser.'), 'https://www.bwtwater.se', 'assets/images/exhibitors/nordbygg-2026-bwt-vattenteknik-ab.jpg'),
  ('nordbygg-2026-exhibitor-138813', 'nordbygg-2026', 'Bygg & teknik, Tidningen', 'C04:01', jsonb_build_object('en', 'Bygg & teknik är en byggnadsteknisk tidskrift som vänder sig till föreskrivande led i byggbranschen. Varje nummer har ett tema som Tak och Fasad, Akustik och ljudisolering, Brandskydd, Betong, Träbyggnadsteknik samt Geoteknik och grundläggning.

Sveriges äldsta Byggtidning - Grundad 1909', 'sv', 'Bygg & teknik är en byggnadsteknisk tidskrift som vänder sig till föreskrivande led i byggbranschen. Varje nummer har ett tema som Tak och Fasad, Akustik och ljudisolering, Brandskydd, Betong, Träbyggnadsteknik samt Geoteknik och grundläggning.
...
Sveriges äldsta Byggtidning - Grundad 1909'), 'https://www.byggteknikforlaget.se', 'assets/images/exhibitors/nordbygg-2026-bygg-teknik-tidningen.jpg'),
  ('nordbygg-2026-exhibitor-137820', 'nordbygg-2026', 'Byggbranschens säkerhetspark', 'B04:41', jsonb_build_object('en', 'Byggbranschens utbildningscenter är Byggföretagens utbildningsverksamhet. Vi erbjuder branschnära utbildningar som stärker kompetensen i bygg och anläggning, för både yrkesarbetare och tjänstemän. Du kan gå utbildning i klassrum, på distans eller i Byggbranschens säkerhetspark.
...
Vi hjälper dig att ringa in kompetensbehovet och välja rätt nästa steg utifrån din roll, dina projekt och aktuella krav.'), 'https://www.buc.se', 'assets/images/exhibitors/nordbygg-2026-byggbranschens-sakerhetspark.jpg'),
  ...
  ('nordbygg-2026-exhibitor-138415', 'nordbygg-2026', 'Byggkeramikrådet AB', 'AG:12', jsonb_build_object('en', 'Byggkeramikrådet (BKR) bildades 1989 av Plattsättningsentreprenörerna (PER) och Kakelföreningen (KAF) för att samla entreprenörer och leverantörer inom kakel och klinker – byggkeramik – i en gemensam organisation.
...
Vårt mål är att säkerställa en kvalitativ och hållbar användning av ett av världens äldsta byggmaterial – lika naturligt, hållbart och vackert i framtiden som det varit under tusentals år.', 'sv', 'Byggkeramikrådet (BKR) bildades 1989 av Plattsättningsentreprenörerna (PER) och Kakelföreningen (KAF) för att samla entreprenörer och leverantörer inom kakel och klinker – byggkeramik – i en gemensam organisation.
...
Vårt mål är att säkerställa en kvalitativ och hållbar användning av ett av världens äldsta byggmaterial – lika naturligt, hållbart och vackert i framtiden som det varit under tusentals år.'), 'https://www.bkr.se', 'assets/images/exhibitors/nordbygg-2026-byggkeramikradet-ab.jpg'),
  ...
  ('nordbygg-2026-exhibitor-139406', 'nordbygg-2026', 'Byggsektorns Miljöberäkningsplattform', 'EH:15', jsonb_build_object('en', 'Utbildning, personlig rådgivning och en ledande beräkningsplattform för klimatdeklarationer.', 'sv', 'Utbildning, personlig rådgivning och en ledande beräkningsplattform för klimatdeklarationer.'), 'https://bm.se/', 'assets/images/exhibitors/nordbygg-2026-byggsektorns-miljoberakningsplattform.jpg'),
  ('nordbygg-2026-exhibitor-133991', 'nordbygg-2026', 'Byggström', 'B08:21', jsonb_build_object('en', 'Malmbergs är ett ledande handelshus i el på den nordiska marknaden för installatörer,
...
”Bygg-Ström anpassar praktiska, prisvärda och funktionella produkter för branschen inom tillfällig el”.', 'sv', 'Malmbergs är ett ledande handelshus i el på den nordiska marknaden för installatörer,
industri-, bygg- och uthyrningsföretag samt återförsäljare.
...
insert into public.point_addons (
  ...
  ('nordbygg-2026-addon-gift-bag', 'nordbygg-2026',
   jsonb_build_object('en', 'Exhibitor gift bag', 'sv', 'Exhibitor gift bag'),
   jsonb_build_object('en', 'Simulated add-on. A curated canvas tote with samples, a sustainability guide, and a Nordbygg pin.', 'sv', 'Simulated add-on. A curated canvas tote with samples, a sustainability guide, and a Nordbygg pin.'),
   80, 'assets/images/events/nordbygg-2026.jpg', 50, true),
  ('nordbygg-2026-addon-sustainability-stage', 'nordbygg-2026',
   jsonb_build_object('en', 'Sustainability Stage seat reservation', 'sv', 'Sustainability Stage seat reservation'),
   jsonb_build_object('en', 'Simulated add-on. Reserves a front-row seat at the Sustainability Stage keynote on day one.', 'sv', 'Simulated add-on. Reserves a front-row seat at the Sustainability Stage keynote on day one.'),
   150, 'assets/images/events/nordbygg-2026.jpg', 20, true),
  ('nordbygg-2026-addon-catalog', 'nordbygg-2026',
   jsonb_build_object('en', 'Event catalog hardcover', 'sv', 'Event catalog hardcover'),
   jsonb_build_object('en', 'Simulated add-on. Hardcover copy of the Nordbygg 2026 catalog with exhibitor index and floor plan.', 'sv', 'Simulated add-on. Hardcover copy of the Nordbygg 2026 catalog with exhibitor index and floor plan.'),
   120, 'assets/images/events/nordbygg-2026.jpg', null, true),
  ('estro-2026-addon-gift-bag', 'estro-2026',
   jsonb_build_object('en', 'Delegate gift bag', 'sv', 'Delegate gift bag'),
   jsonb_build_object('en', 'Simulated add-on. ESTRO 2026 delegate tote with abstracts booklet and sponsor samples.', 'sv', 'Simulated add-on. ESTRO 2026 delegate tote with abstracts booklet and sponsor samples.'),
   80, 'assets/images/events/estro-2026.webp', 50, true),
  ('estro-2026-addon-vip-keynote', 'estro-2026',
   jsonb_build_object('en', 'VIP access to keynote', 'sv', 'VIP access to keynote'),
   jsonb_build_object('en', 'Simulated add-on. Priority seating and a meet-and-greet slot after the opening keynote.', 'sv', 'Simulated add-on. Priority seating and a meet-and-greet slot after the opening keynote.'),
   200, 'assets/images/events/estro-2026.webp', 10, true),
  ('estro-2026-addon-proceedings', 'estro-2026',
   jsonb_build_object('en', 'Proceedings hardcover', 'sv', 'Proceedings hardcover'),
   jsonb_build_object('en', 'Simulated add-on. Hardcover printing of the full ESTRO 2026 proceedings.', 'sv', 'Simulated add-on. Hardcover printing of the full ESTRO 2026 proceedings.'),
...
insert into public.merchandise (
  ...
  ('merch-tote-bag',
   jsonb_build_object('en', 'Stockholmsmassan tote bag', 'sv', 'Stockholmsmassan tote bag'),
   jsonb_build_object('en', 'Simulated item. Sturdy canvas tote with the Stockholmsmassan wordmark.', 'sv', 'Simulated item. Sturdy canvas tote with the Stockholmsmassan wordmark.'),
   120, 'assets/images/merchandise/tote-bag.svg', null, true),
  ('merch-cap',
   jsonb_build_object('en', 'Stockholmsmassan cap', 'sv', 'Stockholmsmassan cap'),
   jsonb_build_object('en', 'Simulated item. Six-panel cap with embroidered Stockholmsmassan logo.', 'sv', 'Simulated item. Six-panel cap with embroidered Stockholmsmassan logo.'),
   150, 'assets/images/merchandise/cap.svg', 100, true),
  ('merch-notebook',
   jsonb_build_object('en', 'Notebook', 'sv', 'Notebook'),
   jsonb_build_object('en', 'Simulated item. A5 hardcover notebook with numbered pages and a ribbon marker.', 'sv', 'Simulated item. A5 hardcover notebook with numbered pages and a ribbon marker.'),
   90, 'assets/images/merchandise/notebook.svg', null, true),
  ('merch-enamel-pin',
   jsonb_build_object('en', 'Enamel pin', 'sv', 'Enamel pin'),
   jsonb_build_object('en', 'Simulated item. Enamel pin with the Stockholmsmassan roundel.', 'sv', 'Simulated item. Enamel pin with the Stockholmsmassan roundel.'),
